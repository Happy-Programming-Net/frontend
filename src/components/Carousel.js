                  ...
                  <ul className="list-disc w-9/12 ">
                    <li>
                      <h1 className="text-lg pl-1 pb-2 tracking-wide font-serif text-[#2e372e] font-bold">
                        Fun and interactive lessons blend math concepts with
                        coding challenges
                      </h1>
                    </li>
                    <li>
                      <h1 className="text-lg pl-1 pb-2 tracking-wide font-serif text-[#2e372e] font-bold">
                        Foster problem-solving and creativity by game and
                        website design
                      </h1>
                    </li>
                    ...
                    <li>
                      <h1 className="text-lg pl-1 pb-5 tracking-wide font-serif text-[#2e372e] font-bold">
                        Develop computational thinking skills essential for
